...
@Test
    ...
    List<WebElement> allcellisInOneRow = driver.findElements(By.xpath("//table[@id='table1']/tbody/tr[1]/td"));

    for (WebElement element : allcellisInOneRow) {
...
@Test
    ...
    //iterate trough each cell in the row
...
//column degismedikce bu kadu row degisse bile kullanabiliriz
